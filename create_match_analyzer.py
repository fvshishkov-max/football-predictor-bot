# create_match_analyzer.py
"""
Создает исправленную версию match_analyzer.py
"""
...
print("✅ match_analyzer.py полностью пересоздан")
print("✅ Метод _calculate_time_factor исправлен")