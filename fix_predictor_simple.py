# fix_predictor_simple.py
"""
Создание predictor.py через прямое копирование
"""

import os

# Читаем содержимое из существующего файла, если он есть
if os.path.exists('predictor.py.bak'):
    print("Found backup, restoring...")
    with open('predictor.py.bak', 'r', encoding='utf-8') as f:
        content = f.read()
else:
    print("Creating new predictor.py...")
    
    # Создаем содержимое построчно
    lines = [
        'import numpy as np',
